...
async function getReportePedidosRangoFecha(pEmpresa, pFecIni, pFecFin){
    ...
    var requestOptions = {
        ...
        var rGetPedidosRangoFecha = await fetch(WebApiServer + "api/Cartera/GetPedidosRangoFecha?Empresa=" + pEmpresa +"&FecIni=" + pFecIni+"&FecFin=" + pFecFin, requestOptions)
        .then(response => response.json());

        await loadTable(rGetPedidosRangoFecha);
...
$("#bt-generar").click(async function (){
    ...
    await getReportePedidosRangoFecha(cEmpresa, cFechaInicial, cFechaFinal);
