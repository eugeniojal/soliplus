...
async function getReporteAprobacionesSemanales(pEmpresa, pFechaIni, pFechaFin) {
    ...
    var cReporteAprobacionesSemanale = await fetch(`${WebApiServer}api/Cartera/GetReporteAprobacionesSemanales?Empresa=${pEmpresa}&FechaIni=${pFechaIni}&FechaFin=${pFechaFin}`, requestOptions)
        .then(response => response.json())

    await loadTable(cReporteAprobacionesSemanale);
...
$("#bt-generar").click(async function () {
    ...
    await getReporteAprobacionesSemanales(cEmpresa, cFechaInicial, cFechaFinal);
